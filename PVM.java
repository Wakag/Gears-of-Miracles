      ...
      do {
        ...
        switch (cpu.ir) {         // execute
          ...
          case PVM.heap:          // heap dump (debugging)
            ...
            break;
          case PVM.dis_3:        //discard 3 items on stack (task 9)
            cpu.sp += 3;
            break;  
          case PVM.sqr:          //sqaure of value on top of stack (task 7)
            tos = pop();
            push(tos * tos); 
            break;
          case PVM.sqrt:        //square root of value on top of stack (task 7)
            tos = pop();
            push(Math.sqrt(tos)); 
            break;
