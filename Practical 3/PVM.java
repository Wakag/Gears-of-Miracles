...
// P.D. Terry, Rhodes University, 2009; Modified KL Bradshaw, 2024 
...
//++
		  ...
		  case PVM.heap:           // heap dump (debugging)
            ...
            break;
          //ADDED CODE HERE FOR LOADING CONSTANT 0-3
          ...
          case PVM.ldc_3:         // push constant 3
            push(3);
            break;
          //ADDED CODE HERE FOR LOADING ADDRESSES
          ...
          case PVM.lda_3:         // push local address 3
            ...
            if (inBounds(adr)) push(adr);
            break;
          //ADDED CODE HERE FOR LOADING ADDRESS AND VALUE IN SAME OPCODE
          ...
          case PVM.ldl_3:         // push value of local variable 3
            ...
            if (inBounds(adr)) push(mem[adr]);
            break;
          //ADDED CODE HERE FOR STORING VALUE AT TOS
          ...
          case PVM.stl_3:         // pop to local variable 3
            ...
            if (inBounds(adr)) mem[adr] = pop();
            break;
          //ADDED CODE HERE FOR STORING CONSTANTS
